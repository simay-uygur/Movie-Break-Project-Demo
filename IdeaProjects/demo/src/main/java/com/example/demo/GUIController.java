...
public class GUIController {
    ...
    @FXML
    private Button b1, b2, b3, b4, b5, b6, b7, b8, b9, b10; // user search friend add buttons
    @FXML
    private MenuItem addToFav0, addToFav1, addToFav2, addToFav3, addToFav4, addToFav5, addToFav6, addToFav7, addToFav8,
            addToFav9;
    @FXML
    private Button r1, r2, r3, r4, r5; // remove friend from profile2 buttons
    @FXML 
...
/* 
    public void displayFavMovies(){
        ...
        helperChangeUser1(moviesDisplayedids1);
        helperChangeUser2(moviesDisplayedids2);
        disp2++;
    }
*/
